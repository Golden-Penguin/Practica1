...
# Title: Parte3
# Author: MiguelBuitrago_JeanRodrigez
# Copyright: UIS
...
class Practica1Parte3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Parte3")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 15e3, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 24e3, 1, 0, 0)
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_freq_sink_x_1, 1))
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.rational_resampler_xxx_2, 0), (self.qtgui_freq_sink_x_1, 2))
